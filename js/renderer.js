...
var Renderer = Renderer || {
    ...
    _renderer   : undefined,
    _controls   : undefined,
    _camera     : undefined, // added
    _bgcam      : undefined,
    _stats      : undefined,
    _scene      : undefined,
    _background : undefined, // added
...
Renderer.create = function( scene, canvas ) {
    ...
    Renderer._renderer.setClearColor( 0x555555 );//c5e1d7
    ...
    // Create background camera (added)
    Renderer._bgcam    = new THREE.PerspectiveCamera ( 55, Renderer._aspect, 0.01, 5000 );
    Renderer._controls = new THREE.TrackballControls ( Renderer._bgcam, Renderer._renderer.domElement );
    Renderer._bgcam.position.set( 0, 40, 100 );
    ...
    Renderer._background = scene._background; // added
...
// this is where ball animation code should go?? 
Renderer.update = function () {
    ...
    //background scene rendering (added)
    Renderer._renderer.autoClear = false;
    Renderer._renderer.clear();
    Renderer._renderer.render( Renderer._background, Renderer._bgcam );
